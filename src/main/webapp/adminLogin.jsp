...
<div class="container" style="width: 400px;">
    <form action="${pageContext.request.contextPath}/adminLoginServlet" method="post">
        <div style="float: right;font-size: x-small">
            <a class="btn btn-primary"  href="${pageContext.request.contextPath}/login.jsp">回到用户登录页面</a>
        </div>
    <h3 style="text-align: center;">管理员登录</h3>
        <div class="form-group">
            <label for="admin">用户名：</label>
            <input type="text" name="adname" class="form-control" id="admin" placeholder="请输入用户名"/>
        </div>
