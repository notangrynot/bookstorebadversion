...
<div class="container" style="width: 400px">
    ...
    <form action="${pageContext.request.contextPath}/addBookServlet" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="ISBN" placeholder="请输入ISBN号">
        </div>

        <div class="form-group">
            <label for="clasno">类型编号</label>
            <input type="text" class="form-control" id="clasno" name="clasno" placeholder="请输入类型编号"/>
        </div>
        <div class="form-group">
